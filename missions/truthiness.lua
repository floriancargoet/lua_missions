...
-- Why?
--
-- I would rather compare "if obj then" to "if obj ~= nil then"
-- if obj cannot be == false, then "if obj then" is fine.
-- It's more concise than the not nil version and imho just as easily understandable
--
-- If it can be == false, be explicit and use if obj ~= nil then
